    ...
    <div class="container">
        ...
        try {
            ...
            if (isset($_GET['search'])) {
                ...
                $stmt = $conn->prepare("SELECT project_id, project_name, project_about, type_project FROM projects WHERE project_name LIKE :search OR type_project LIKE :search LIMIT $start_index, $results_per_page");
                $stmt->bindParam(':search', $search, PDO::PARAM_STR);
            } else {
                $stmt = $conn->prepare("SELECT project_id, project_name, project_about, type_project FROM projects LIMIT $start_index, $results_per_page");
            }
